...
pub fn Sidebar() -> impl IntoView
{
    ...
    view! 
    {
        ...
        <Suspense fallback=move || { view! {<p>"Loading jam..."</p>} }>
        {
            move || Suspend::new(async move {
                ...
                let res = match jams {
                    Ok(jams) => jams,
                    Err(_) => vec![JamQueryResult { id:-1, data: "Failure".to_string() }],
                };
                view! 
                {
                    <For 
            ...
            <Suspense fallback=move || { view! {<p>"Loading tracks..."</p>} }>
            {
                move || Suspend::new(async move {
